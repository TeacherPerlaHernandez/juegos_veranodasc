...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.princes, function (sprite, otherSprite) {
    sprites.destroy(princes)
    game.gameOver(false)
})
...
game.onUpdateInterval(1000, function () {
    enemigo = sprites.create(img`
        ...
        ........................
        `, SpriteKind.Enemy)
    enemigo.setPosition(6, randint(5, 110))
    enemigo.follow(princes, 50)
})
game.onUpdateInterval(1000, function () {
    enemigo = sprites.create(img`
        f f f . . . . . . . . f f f . . 
